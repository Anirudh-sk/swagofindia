        ...
        <div class="container-fluid w-75 p-0" id="categories">
            ...
            <div class="row">
                <div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <img src="https://swagofindia.netlify.app/Images/cat1.png" alt="womens wear" >
                ...
                <div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <img src="https://swagofindia.netlify.app/Images/cat2.png" alt="ethnic wear" >
                ...
                <div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mt-lg-0 mt-md-4 mt-sm-4 mt-xs-0">
                    <img src="https://swagofindia.netlify.app/Images/cat3.png" >
